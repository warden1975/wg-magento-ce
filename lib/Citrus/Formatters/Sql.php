...
class Citrus_Formatters_Sql
{
    ...
    protected static function init()
    {
        ...
        usort(self::$reserved, array('Citrus_Formatters_Sql', 'sortLength'));

        // Set up regular expressions
        self::$regex_boundaries = '('.implode('|',array_map(array('Citrus_Formatters_Sql', 'quote_regex'),self::$boundaries)).')';
        self::$regex_reserved = '('.implode('|',array_map(array('Citrus_Formatters_Sql', 'quote_regex'),self::$reserved)).')';
        self::$regex_reserved_toplevel = str_replace(' ','\\s+','('.implode('|',array_map(array('Citrus_Formatters_Sql', 'quote_regex'),self::$reserved_toplevel)).')');
        self::$regex_reserved_newline = str_replace(' ','\\s+','('.implode('|',array_map(array('Citrus_Formatters_Sql', 'quote_regex'),self::$reserved_newline)).')');

        self::$regex_function = '('.implode('|',array_map(array('Citrus_Formatters_Sql', 'quote_regex'),self::$functions)).')';
